...
import {
  ...
  tsxLanguage,
  typescriptLanguage
} from "./chunk-Z5G3Q63K.js";
import "./chunk-6KGBDEXZ.js";
import {
  ContextTracker,
  ExternalTokenizer,
  LRParser
} from "./chunk-BWSJTSJ3.js";
import {
  LRLanguage,
  LanguageSupport,
  ...
  indentNodeProp,
  syntaxTree
} from "./chunk-IVHALWPV.js";
import {
  parseMixed,
  styleTags,
  tags
} from "./chunk-3PJH23XL.js";
import {
  EditorView
} from "./chunk-63KR2RLT.js";
import {
  EditorSelection
} from "./chunk-DDDYQH4I.js";
...
var autoCloseTags = EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
  ...
  let closeTags = state.changeByRange((range) => {
    ...
    if (didType && text == ">" && after.name == "EndTag") {
      ...
      if ((name = elementName(state.doc, tag.parent, head)) && !selfClosers2.has(name) && !isClosed(state.doc, tag.parent, name)) {
      ...
      let tag = after.parent;
      if (after.from == head - 2 && ((_a = tag.lastChild) === null || _a === void 0 ? void 0 : _a.name) != "CloseTag" && (name = elementName(state.doc, tag, head)) && !selfClosers2.has(name)) {
        let to2 = head + (state.doc.sliceString(head, head + 1) === ">" ? 1 : 0);
        let insert = `${name}>`;
        return {
