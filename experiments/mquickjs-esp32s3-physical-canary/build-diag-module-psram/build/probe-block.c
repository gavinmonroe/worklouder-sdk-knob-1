...
const unsigned int framer_probe_values[] = {
    ...
    (unsigned int)(offsetof(physical_block, target_admitted)),
    (unsigned int)(offsetof(physical_block, scene_persist_status)),
    (unsigned int)(offsetof(physical_block, scene_persist_generation)),
    (unsigned int)(offsetof(physical_block, scene_persist_observed)),
