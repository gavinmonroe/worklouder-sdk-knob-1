...
//#region ../web-flasher/node_modules/esptool-js/lib/targets/esp32h2.js
var ESP32H2ROM = class extends ESP32C6ROM {
	constructor() {
		super(...arguments);
	...
	async getPkgVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 16) >> 0 & 7;
	}
	async getMinorChipVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 12) >> 18 & 7;
	}
	async getMajorChipVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 12) >> 21 & 3;
	}
	async getChipDescription(loader) {
		const pkgVer = await this.getPkgVersion(loader);
		let desc;
		if (pkgVer === 0) desc = "ESP32-H2";
		else desc = "unknown ESP32-H2";
