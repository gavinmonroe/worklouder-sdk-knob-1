...
import { t as ROM } from "./rom-CmtXF_pI.js";
//#region ../web-flasher/node_modules/esptool-js/lib/targets/esp32.js
var esp32_exports = /* @__PURE__ */ __exportAll({ ESP32ROM: () => ESP32ROM });
var ESP32ROM = class extends ROM {
	...
	async getChipDescription(loader) {
		...
		if ((await this.readEfuse(loader, 3) & 1) != 0) {
	...
	async getChipFeatures(loader) {
		...
		const word3 = await this.readEfuse(loader, 3);
		if ((word3 & 2) === 0) features.push(" BT");
		if ((word3 & 1) !== 0) features.push(" Single Core");
		else features.push(" Dual Core");
		if ((word3 & 8192) !== 0) {
			if ((word3 & 4096) !== 0) features.push(" 160MHz");
		...
		if ((await this.readEfuse(loader, 4) >> 8 & 31) !== 0) features.push(" VRef calibration in efuse");
		if ((word3 >> 14 & 1) !== 0) features.push(" BLK3 partially reserved");
		const codingScheme = await this.readEfuse(loader, 6) & 3;
		features.push(" Coding Scheme " + [
			"None",
			"3/4",
			"Repeat (UNSUPPORTED)",
			"Invalid"
...
//#endregion
export { esp32_exports as n, ESP32ROM as t };
