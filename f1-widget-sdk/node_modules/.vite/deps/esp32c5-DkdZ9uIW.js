import { ESP32C6ROM } from "./esp32c6-CZYXd1YS.js";
//#region ../web-flasher/node_modules/esptool-js/lib/targets/esp32c5.js
var ESP32C5ROM = class extends ESP32C6ROM {
	...
	async getPkgVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 8) >> 26 & 7;
	}
	async getMinorChipVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 8) >> 0 & 15;
	}
	async getMajorChipVersion(loader) {
		return await loader.readReg(this.EFUSE_BLOCK1_ADDR + 8) >> 4 & 3;
	}
	...
	async getKeyBlockPurpose(loader, keyBlock) {
		...
		return await loader.readReg(reg) >> shift & 31;
	}
	...
	async usesUsbJtagSerial(loader) {
		...
		return (await loader.readReg(uartBufNoAddr) & 255) === 3;
	}
