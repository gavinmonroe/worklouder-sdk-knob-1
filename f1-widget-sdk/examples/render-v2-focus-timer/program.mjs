...
export const HOST_SYNC_SECONDS = 95 * 60;
export const INITIAL_SECONDS = 25 * 60;
export const TIMER_MIN_SECONDS = 5 * 60;
export const TIMER_MAX_SECONDS = 95 * 60;
export const TIMER_STEP_SECONDS = 5 * 60;
...
export function leBufferToRgb565Frame(buffer) {
  if (!Buffer.isBuffer(buffer) || buffer.length !== VIEWPORT.width * VIEWPORT.height * 2) {
    throw new Error("Focus timer framebuffer must be the exact 62,000-byte RGB565 buffer.");
  }
